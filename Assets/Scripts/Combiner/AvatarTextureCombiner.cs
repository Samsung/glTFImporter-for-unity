...
/// 
/// </summary>
public static class AvatarTextureCombiner
{
    /// <summary>
    ...
    /// <returns></returns>
        ...
        /// <returns></returns>
        public static Texture2D MakeEmptyTexture(Vector2Int size, TextureFormat textureFormat = TextureFormat.RGBA32)
        {
        ...
        /// <param name="textureFormat">The texture format.</param>
        /// <returns></returns>
        public static Texture2D GetResizedTexture2D(Texture texture, Vector2Int size, TextureFormat textureFormat = TextureFormat.RGBA32)
        {
        ...
        /// <param name="newFormat">The new format.</param>
        /// <returns></returns>
        private static Texture2D ChangeFormat(Texture2D oldTexture, TextureFormat newFormat = TextureFormat.RGBA32)
        {
